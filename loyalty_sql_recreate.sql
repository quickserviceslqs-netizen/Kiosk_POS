...
-- Add loyalty fields to existing tables using a safer approach
...
INSERT INTO sales_temp (
    sale_id, date, time, total, payment, change, receipt_number,
    payment_received, payment_method, subtotal, vat_amount, discount_amount,
    customer_id, user_id, voided, void_reason, voided_by, voided_at
)
SELECT
    sale_id, date, time, total, payment, change, receipt_number,
    payment_received, payment_method, subtotal, vat_amount, discount_amount,
