#!/usr/bin/env python3
"""Test date filtering with mixed formats."""
...
query = """
    ...
    AND (
        CASE 
            WHEN reconciliation_date LIKE '__.__.__' THEN DATE(SUBSTR(reconciliation_date, 7, 4) || '-' || SUBSTR(reconciliation_date, 4, 2) || '-' || SUBSTR(reconciliation_date, 1, 2))
...
print(f'Improved date filter test:')
